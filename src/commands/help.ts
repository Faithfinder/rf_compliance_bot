...
export const HELP_PREAMBLE = [
    ...
    "",
    "Это размен удобства на надёжность. Модерация удобнее, но проверяет уже опубликованный пост: при недоступном боте немаркированный пост останется в канале незамеченным. Публикация через бота неудобнее, зато при недоступном боте просто не выпустит пост.",
].join("\n");
