...
export const commandDefinitions: CommandDefinition[] = [
    ...
    },
    {
        ...
        helpText: `/notify_add - Добавить администратора в список получателей уведомлений об отклоненных сообщениях. Откроется кнопка для выбора пользователя.`,
    ...
    },
    {
        ...
        helpText: `/notify_list - Показать список администраторов, получающих уведомления об отклоненных сообщениях`,
        register: () => {},
    },
];
